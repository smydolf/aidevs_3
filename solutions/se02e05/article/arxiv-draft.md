...
![Czarno-białe zdjęcie przedstawia brukowany plac miejski o zmierzchu lub świcie. Na pierwszym planie widoczne są gołębie spacerujące po bruku. W tle widać sylwetki ludzi oraz budynki z wieżą zegarową po prawej stronie. Na niebie unoszą się ptaki, a chmury są rozświetlone przez słońce znajdujące się nisko nad horyzontem.](rynek.png)
...
![Czarno-białe zdjęcie przedstawia plac z brukowaną nawierzchnią, na którym widać kilka gołębi. W tle znajduje się grupa ludzi i budynki z wieżą zegarową. Na niebie widać chmury i stado ptaków w locie. Po prawej stronie obrazu widoczne są zakłócenia w postaci kolorowych linii. Słońce znajduje się nisko nad horyzontem, tworząc efektowne cienie.](rynek_glitch.png)
...
![Na zdjęciu widać truskawkę leżącą na gładkiej powierzchni. Jest pokryta kroplami wody, co dodaje jej świeżości. W tle znajduje się rozmyte wnętrze pomieszczenia, które sugeruje, że zdjęcie zostało zrobione w kuchni lub jadalni.](fruit01.png)

Owoc przed transportem w czasie

![Na zdjęciu widać truskawkę leżącą na gładkiej powierzchni, prawdopodobnie na metalowym blacie. W tle znajduje się przezroczyste pudełko. Zdjęcie jest w czerni i bieli, co nadaje mu klasyczny wygląd. Truskawka rzuca delikatny cień na blat.](fruit02.png)
...
![Czarno-białe zdjęcie przedstawia owoc, który jest połączeniem truskawki i wiśni. Ma kształt truskawki z charakterystycznymi wypustkami na powierzchni, a na górze widoczna jest łodyżka przypominająca tę od wiśni. Po bokach znajdują się liście.](strangefruit.png)
...
![Na talerzu znajduje się pizza pokrojona na sześć kawałków. Na każdym kawałku widać kawałki ananasa oraz posypkę, prawdopodobnie ziół. Zdjęcie jest czarno-białe, co nadaje mu kontrastowy wygląd.](resztki.png)
